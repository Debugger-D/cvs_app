 ...
 * |-----------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------|
 * | {@link ng.directives:ngRepeat#usage_animations ngRepeat}                                                   | enter, leave and move                                                    |
 * | {@link ngRoute.directives:ngView#usage_animations ngView}                                                  | enter and leave                                                          |
 * | {@link ng.directives:ngInclude#usage_animations ngInclude}                                                 | enter and leave                                                          |
 * | {@link ng.directives:ngSwitch#usage_animations ngSwitch}                                                   | enter and leave                                                          |
 * | {@link ng.directives:ngIf#usage_animations ngIf}                                                           | enter and leave                                                          |
 * | {@link ng.directives:ngClass#usage_animations ngClass}                                                     | add and remove (the CSS class(es) present)                               |
 * | {@link ng.directives:ngShow#usage_animations ngShow} & {@link ng.directives:ngHide#usage_animations ngHide} | add and remove (the ng-hide class value)                                 |
 * | {@link ng.directives:form#usage_animations form} & {@link ng.directives:ngModel#usage_animations ngModel}   | add and remove (dirty, pristine, valid, invalid & all other validations) |
 * | {@link ngMessages.directives:ngMessage#usage_animations ngMessages}                                        | add and remove (ng-active & ng-inactive)                                 |
 * | {@link ngMessages.directives:ngMessage#usage_animations ngMessage}                                         | enter and leave                                                          |
 *
